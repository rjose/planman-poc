...
(function() {
    ...
    function handleClick(event) {
        ...
        if (event.target.isDrag) {
            ...
            Planman.startPoint = {x: event.target.width.baseVal.value};
        }
    }
    ...
    function handleMove(event) {
        ...
        event.target.width.baseVal.value = Planman.startPoint.x + delta.x;
    }
    ...
    Planman.resizeRectangle = function(rect, newWidth) {
        rect.width.baseVal.value = newWidth;
    }
